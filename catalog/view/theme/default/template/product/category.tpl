...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <?php } ?>
      <?php if ($categories) { ?>
      <h3 class="category-list-title"><?php echo $text_refine; ?></h3>
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <ul>
            <?php foreach ($categories as $category) { ?>
            <li>s<a href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a></li>
            <?php } ?>
          </ul>
        </div>
        <?php } ?>
      ...
      <?php } ?>
      <?php if ($products) { ?>
      <p class="compare-list"><a href="<?php echo $compare; ?>" id="compare-total"><?php echo $text_compare; ?></a></p>
      <div class="row">
        <div class="col-md-4">
          <div class="btn-group view-mode hidden-xs">
