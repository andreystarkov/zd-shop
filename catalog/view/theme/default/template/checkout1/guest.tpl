  ...
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="form-group required" style="display:none">
        ...
        <input type="text" name="lastname" value="Клиент" placeholder="<?php echo $entry_lastname; ?>" id="input-payment-lastname" class="form-control" />
      </div>
      ...
      <div class="form-group" style="display:none">
        ...
        <input type="text" name="fax" value="000" placeholder="<?php echo $entry_fax; ?>" id="input-payment-fax" class="form-control" />
      </div>
  ...
  <div class="col-sm-6">
    <fieldset id="address">
      ...
      <div class="form-group" style="display:none">
        ...
        <input type="text" name="company" value="Нет" id="input-payment-company" class="form-control" />
      </div>
      <div class="form-group">
      ...
      <div class="form-group" style="display:none">
        ...
        <input type="text" name="postcode" value="000" placeholder="<?php echo $entry_postcode; ?>" id="input-payment-postcode" class="form-control" />
      </div>
      <div class="form-group" style="display:none">
      ...
      <div class="form-group" style="display:none">
        ...
        <select name="zone_id" id="input-payment-zone" class="form-control">
          <option value="46" selected="selected"></option>
        </select>
      </div>
      <?php foreach ($custom_fields as $custom_field) { ?>
